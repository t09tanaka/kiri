...
"#;
        ...
        assert!(
            transform_compose_content(content, &assignments).contains("127.0.0.1:3100:3000"),
            "Expected IP-bound port transformed"
        );
        assert!(
            transform_compose_content(content, &assignments).contains("0.0.0.0:8180:8080"),
            "Expected IP-bound port transformed"
        );
    }
